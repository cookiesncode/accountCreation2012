						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-7 col-md-6">
									...
									<asp:RegularExpressionValidator ID="_phoneExpressionValidator" CssClass="label label-warning" ControlToValidate="_phone" runat="server" ErrorMessage="Phone: Please enter a valid Office number, i.e., 719.526/524/503/549.XXXX" Display="Dynamic" ValidationExpression="719\.(526|524|503|549)\.\d{4}">Requires your attention.</asp:RegularExpressionValidator>
								</div>
							</div>
