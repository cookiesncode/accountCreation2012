	...
	public partial class SA_Admin : System.Web.UI.Page
	{
        ...
        protected void _iaSubmit_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                else
                {
                    ...
                    var customerEmailMessage = "This account has been denied by IA. For more information, please contact Clifton Myers at Clifton.f.myers2.ctr@mail.mil or Jeremy Cortez at jeremy.d.cortez.civ@mail.mil";
        ...
        protected void _dsdSubmit_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                if (dsdApprovalCtrl.SelectedValue == "Approved")
                {
                    ...
                    var necEmailAddress = "usarmy.carson.106-sig-bde.list.nec-ssd-smb-sa@mail.mil, jeremy.d.cortez.civ@mail.mil, Clifton.f.myers2.ctr@mail.mil";
                ...
                {
                    requestStatusCtrl.Text = "Denied";
                    var necEmailAddress = "jeremy.d.cortez.civ@mail.mil, Clifton.f.myers2.ctr@mail.mil ";
        ...
        protected void _saSubmit_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    necEmailAddress = "jeremy.d.cortez.civ@mail.mil, Clifton.f.myers2.ctr@mail.mil ";
                }
