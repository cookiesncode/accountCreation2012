	...
	public partial class SA_Admin : System.Web.UI.Page
	{
        ...
        protected void _dsdSubmit_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                if (dsdApprovalCtrl.SelectedValue == "Approved")
                {
                    ...
                    var necEmailAddress = "usarmy.carson.106-sig-bde.list.nec-ssd-smb-sa@mail.mil, jeremy.d.cortez.civ@mail.mil, glen.p.wilson.civ@mail.mil";
                ...
                {
                    requestStatusCtrl.Text = "Denied";
                    var necEmailAddress = "jeremy.d.cortez.civ@mail.mil, glen.p.wilson.civ@mail.mil";
        ...
        protected void _saSubmit_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                if (IsSaCreateRequest)
                {
                    necEmailAddress = "michael.j.hahn10.civ@mail.mil, jeremy.d.cortez.civ@mail.mil, glen.p.wilson.civ@mail.mil";
                }
                else
                {
                    necEmailAddress = "jeremy.d.cortez.civ@mail.mil, glen.p.wilson.civ@mail.mil";
                }
